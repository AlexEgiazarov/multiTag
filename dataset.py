...
class AttributesDataset():
    ...
    def __init__(self, annotation_path):
        ...
        #empty lists for color gender and article data
        color_labels = []
        gender_labels = []
        article_labels = []
        ...
        #create corresponding dicts with ids and data
...
class FashionDataset(Dataset):
    ...
    def __init__(self, annotation_path, attributes, transform=None):
        ...
        #initialize the arrays to store the ground truth labels and path to the images
        self.data = []
        self.color_labels = []
        self.gender_labels = []
        self.article_labels = []
    ...
    def __getitem__(self, idx):
        #take the data saple by its index
